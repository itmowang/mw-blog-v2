...
const updateSave = async (req, res)=>{
    ...
    if (verifys?.data) {
        ...
        const post = await _lib_prisma__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.post.update({
            where: {
                id: parseInt(id)
            },
            data: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (updateSave);
...
var __webpack_exports__ = __webpack_require__.X(0, [846], () => (__webpack_exec__(9486)));

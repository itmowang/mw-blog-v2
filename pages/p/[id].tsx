        ...
        <div className='h-[1000px] p-2 bg-default flex w-full'>
            ...
            <div className='w-full ml-4 '>
                <div className="w-full h-[850px] bg-white shadow-lg rounded-lg p-2 mb-8">
                    <p className='text-left text-3xl leading-10 indent-5 my-2' style={{ color: 'hsl(0deg,0%,21%)' }} > 
                        {posts.title}
                    </p>
                    <div className='flex indent-2 text-slate-500	'>
                        <div> <span className='cursor-pointer'>魔王</span> / <span className='cursor-pointer'> 电脑网络 </span> / <span className='cursor-pointer'>  0条留言 </span> / <span className='cursor-pointer'> 20次浏览 </span> / <span className='cursor-pointer'> 2天前 </span> </div>
                    </div>
                    {/* 分割线 */}

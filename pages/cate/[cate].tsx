                ...
                <div className="w-full   ">
                    {
                        feed.map((post, key) => {
                            return (
                                <div key={key} className='bg-white shadow-lg rounded-lg p-2 mb-4 cursor-pointer'>
                                    <div className="bg-[url(https://www.wdssmq.com/zb_users/theme/acgMora/var/noimg/2.webp)] h-[150px] bg-cover	"></div>
                                    <div className='text-lg text-zinc-600 my-1 font-medium hover:text-sky-500'> {post.title} </div>
                                    <div className='text-zinc-400'><span className='text-sky-500'> #冷笑话 </span> <span className='text-sky-500'> #吐槽 </span>  实在是太懒了，，多加几个“-”会死啊。。 </div>
